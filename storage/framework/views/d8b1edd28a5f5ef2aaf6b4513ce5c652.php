            ...
            <div class="col-md-6 right">
                <div class="input-box">
                    ...
                    <form action="<?php echo e(route('register')); ?>" method="POST">
                        ...
                        <div class="signin">
                        <span>Already have an account? <a href="<?php echo e(route('login')); ?>">Log in here</a></span>
                        </div>
                    </form>
                </div>  
            </div>
...
</html><?php /**PATH E:\laragon\laragon\www\mainpage\resources\views/register.blade.php ENDPATH**/ ?>